...
open class ConsoleDestination: BaseDestination {
    ...
    /// Use this to change the logging method to the console. By default, it is set to .print. You can switch to
    /// .logger(subsystem:category:) to utilize the OSLog API.
